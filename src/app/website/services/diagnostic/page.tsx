...
import { ArrowLeft, ArrowUpRight, CheckCircle, Phone, Settings, Clock, Shield, DollarSign } from "lucide-react";
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <FadeIn>
            <div className="text-center mb-12">
              <h3 className="text-3xl lg:text-4xl font-[family-name:var(--font-saira)] font-bold text-[#070889] uppercase">Why Choose Our Diagnostic</h3>
            </div>
          </FadeIn>
      ...
      <section className="py-24 lg:py-32 bg-[#DC2626]">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-white/80 text-xl mb-10 max-w-2xl mx-auto">
            Don't guess what's wrong with your transmission. Get a professional diagnosis—completely free.
          </p>
